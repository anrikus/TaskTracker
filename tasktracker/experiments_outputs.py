...
LINEAR_PROBES_PATHS_PER_MODEL = {
    ...
    "gpt_oss_20b_harmony": {
        ...
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony/7/model.pickle": 7,
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony/15/model.pickle": 15,
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony/23/model.pickle": 23,
    },
    "gpt_oss_20b_harmony_primed": {
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony_primed/0/model.pickle": 0,
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony_primed/7/model.pickle": 7,
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony_primed/15/model.pickle": 15,
        linear_probe_out_parent_dir + "/gpt_oss_20b_harmony_primed/23/model.pickle": 23,
    },
}
