...
from tasktracker.config.models import (activation_parent_dir,
...
CONSTANTS_ALL_MODELS = {
    ...
    "gpt_oss_20b_primed": {
        "ACTIVATION_FILE_LIST_DIR": DATA_LISTS,
        "ACTIVATIONS_DIR": activation_parent_dir + "gpt_oss_20b_primed/training",
        "ACTIVATIONS_VAL_DIR": activation_parent_dir + "gpt_oss_20b_primed/validation",
    },
    "gpt_oss_20b_harmony": {
        "ACTIVATION_FILE_LIST_DIR": DATA_LISTS,
    ...
    "gpt_oss_20b_harmony_primed": {
        "ACTIVATION_FILE_LIST_DIR": DATA_LISTS,
        "ACTIVATIONS_DIR": activation_parent_dir
        + "gpt_oss_20b_harmony_primed/training",
        "ACTIVATIONS_VAL_DIR": activation_parent_dir
        + "gpt_oss_20b_harmony_primed/validation",
    },
}
...
TEST_ACTIVATIONS_DIR_PER_MODEL = {
    ...
    "gpt_oss_20b_primed": activation_parent_dir + "/gpt_oss_20b_primed/test",
    "gpt_oss_20b_harmony": activation_parent_dir + "gpt_oss_20b_harmony/test",
    "gpt_oss_20b_harmony_primed": activation_parent_dir
    + "gpt_oss_20b_harmony_primed/test",
}
...
TEST_CLEAN_FILES_PER_MODEL = {
    ...
    "gpt_oss_20b_primed": [
        file.strip()
        for file in open(
            os.path.join(DATA_LISTS, "test_clean_files_gpt_oss_20b_primed.txt")
        )
    ],
    "gpt_oss_20b_harmony": [
        file.strip()
        for file in open(
            os.path.join(DATA_LISTS, "test_clean_files_gpt_oss_20b_harmony.txt")
        )
    ],
    "gpt_oss_20b_harmony_primed": [
        file.strip()
        for file in open(
            os.path.join(DATA_LISTS, "test_clean_files_gpt_oss_20b_harmony_primed.txt")
        )
    ],
}
...
TEST_POISONED_FILES_PER_MODEL = {
    ...
    "gpt_oss_20b_primed": [
        file.strip()
        for file in open(
            os.path.join(DATA_LISTS, "test_poisoned_files_gpt_oss_20b_primed.txt")
        )
    ],
    "gpt_oss_20b_harmony": [
        file.strip()
    ...
    "gpt_oss_20b_harmony_primed": [
        ...
        for file in open(
            os.path.join(
                DATA_LISTS, "test_poisoned_files_gpt_oss_20b_harmony_primed.txt"
            )
        )
    ],
}
